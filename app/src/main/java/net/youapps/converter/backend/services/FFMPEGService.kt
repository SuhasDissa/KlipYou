...
import net.youapps.converter.MainActivity
import net.youapps.converter.R
import net.youapps.converter.backend.models.ConverterState
import net.youapps.converter.backend.util.NotificationHelper
import net.youapps.converter.backend.util.PermissionHelper
...
abstract class FFMPEGService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            registerReceiver(
                converterReceiver,
                IntentFilter(SERVICE_INTENT_ACTION),
                RECEIVER_EXPORTED
            )
        } else {
            registerReceiver(
    ...
    override fun onDestroy() {
        ...
        unregisterReceiver(converterReceiver)
    ...
    companion object {
        const val SERVICE_INTENT_ACTION = "net.youapps.converter.SERVICE_ACTION"
